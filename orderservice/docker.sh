...
docker run -d -v /etc/hosts:/etc/hosts --hostname ${hostname} -v /home/workspace/${project_name}/log:/log -p 8086:8086 -p 20882:20882  ${repository}/${project_name}